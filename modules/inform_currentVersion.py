...
# Функция на основе того, в какое пространство установлен Chrome, возвращает:
...
def get_CurrentVersion():
    ...
    # то необходима установка в пространство для всех пользователей,
    ...
    # значит браузер не установлен.
    # Установка и проверка будут производиться в пространстве
